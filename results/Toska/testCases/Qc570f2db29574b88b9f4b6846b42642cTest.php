...
class Qc570f2db29574b88b9f4b6846b42642cTest extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query":"{\n  locations {\n    name\n    talks {\n      description\n      day\n      begin\n      end\n    }\n    workshops {\n      description\n      day\n      begin\n      end\n    }\n    noPhotography\n  }\n}\n","variables":null,"created_at":"2023-05-05 18:48:04","updated_at":"2023-05-05 18:48:04","times_called":1}
JSON;
        ...
        $this->assertArrayHasKey('noPhotography', $responseContent['locations'][$g]);
        
        if ($responseContent['locations'][$g]['noPhotography']) {
        
        $this->assertIsBool($responseContent['locations'][$g]['noPhotography']);
