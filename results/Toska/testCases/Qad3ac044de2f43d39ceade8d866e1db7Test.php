...
class Qad3ac044de2f43d39ceade8d866e1db7Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query":"{\n  people {\n    firstName\n    name\n    keywords\n    location {\n      name\n      about\n      city\n      address\n    }\n    talks {\n      description\n      day\n      begin\n      end\n    }\n    workshops {\n      description\n      day\n      begin\n      end\n    }\n    noPhotography\n  }\n}\n","variables":null,"created_at":"2023-05-05 18:42:43","updated_at":"2023-05-05 18:42:43","times_called":1}
JSON;
        ...
        $this->assertArrayHasKey('noPhotography', $responseContent['people'][$g]);
        
        if ($responseContent['people'][$g]['noPhotography']) {
        
        $this->assertIsBool($responseContent['people'][$g]['noPhotography']);
