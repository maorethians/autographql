...
class Q052e0392238f4a2aa21913f765776ec1Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query":"{\n  themes {\n    id\n    fonts {\n      primary\n      secondary\n      variants {\n        family\n        weight\n        style\n        fileName\n        href\n      }\n    }\n    textures {\n      url\n      title\n      style {\n        backgroundSize\n      }\n    }\n    colors {\n      primary\n      secondary\n      text\n      background\n    }\n  }\n}\n","variables":null,"created_at":"2023-05-05 19:01:12","updated_at":"2023-05-05 19:01:12","times_called":1}
JSON;
