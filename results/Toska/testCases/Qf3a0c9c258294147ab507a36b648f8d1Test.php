...
class Qf3a0c9c258294147ab507a36b648f8d1Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query":"{\n  conferences {\n    id\n    name\n    workshops {\n      description\n      day\n      begin\n      end\n    }\n    attendees {\n      aboutShort\n      company\n      tagline\n      noPhotography\n    }\n    keynotes {\n      description\n      day\n      begin\n      end\n    }\n    fullTalks {\n      description\n      day\n      begin\n      end\n    }\n    lightningTalks {\n      description\n      day\n      begin\n      end\n    }\n  }\n}","variables":null,"created_at":"2023-05-05 18:27:05","updated_at":"2023-05-05 18:27:05","times_called":1}
JSON;
        ...
        $this->assertArrayHasKey('lightningTalks', $responseContent['conferences'][$g]);
        
        $this->assertNotNull($responseContent['conferences'][$g]['lightningTalks']);
        
        $this->assertIsArray($responseContent['conferences'][$g]['lightningTalks']);
        
        for($f = 0; $f < count($responseContent['conferences'][$g]['lightningTalks']); $f++) {
        
        $this->assertNotNull($responseContent['conferences'][$g]['lightningTalks'][$f]);
        
        $this->assertArrayHasKey('description', $responseContent['conferences'][$g]['lightningTalks'][$f]);
        
        if ($responseContent['conferences'][$g]['lightningTalks'][$f]['description']) {
        
        $this->assertIsString($responseContent['conferences'][$g]['lightningTalks'][$f]['description']);
        
        }
        
        $this->assertArrayHasKey('day', $responseContent['conferences'][$g]['lightningTalks'][$f]);
        
        if ($responseContent['conferences'][$g]['lightningTalks'][$f]['day']) {
        
        $this->assertIsString($responseContent['conferences'][$g]['lightningTalks'][$f]['day']);
        
        }
        
        $this->assertArrayHasKey('begin', $responseContent['conferences'][$g]['lightningTalks'][$f]);
        
        if ($responseContent['conferences'][$g]['lightningTalks'][$f]['begin']) {
        
        $this->assertIsString($responseContent['conferences'][$g]['lightningTalks'][$f]['begin']);
        
        }
        
        $this->assertArrayHasKey('end', $responseContent['conferences'][$g]['lightningTalks'][$f]);
        
        if ($responseContent['conferences'][$g]['lightningTalks'][$f]['end']) {
        
        $this->assertIsString($responseContent['conferences'][$g]['lightningTalks'][$f]['end']);
