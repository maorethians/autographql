...
class Q37e267a25e4b4e55a267438ce81e34b7Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query":"{\n  conferences {\n    id\n    name\n    organizer {\n      aboutShort\n      company\n      tagline\n      noPhotography\n    }\n    year\n    startDate\n    endDate\n    slogan\n    websiteUrl\n    locations {\n      name\n      about\n      city\n      address\n    }\n    organizers {\n      aboutShort\n      company\n      tagline\n      noPhotography\n    }\n    mcs {\n      aboutShort\n      company\n      tagline\n      noPhotography\n    }\n    partners {\n      aboutShort\n      company\n      tagline\n      noPhotography\n    }\n    sponsors {\n      aboutShort\n      company\n      tagline\n      noPhotography\n    }\n    goldSponsors {\n      aboutShort\n      company\n      tagline\n      noPhotography\n    }\n    silverSponsors {\n      aboutShort\n      company\n      tagline\n      noPhotography\n    }\n    bronzeSponsors {\n      aboutShort\n      company\n      tagline\n      noPhotography\n    }\n    platformSponsors {\n      aboutShort\n      company\n      tagline\n      noPhotography\n    }\n  }\n}","variables":null,"created_at":"2023-05-05 18:24:32","updated_at":"2023-05-05 18:24:32","times_called":1}
JSON;
        ...
        $this->assertArrayHasKey('bronzeSponsors', $responseContent['conferences'][$g]);
        
        if ($responseContent['conferences'][$g]['bronzeSponsors']) {
        
        $this->assertIsArray($responseContent['conferences'][$g]['bronzeSponsors']);
        
        for($f = 0; $f < count($responseContent['conferences'][$g]['bronzeSponsors']); $f++) {
        
        $this->assertNotNull($responseContent['conferences'][$g]['bronzeSponsors'][$f]);
        
        $this->assertArrayHasKey('aboutShort', $responseContent['conferences'][$g]['bronzeSponsors'][$f]);
        
        if ($responseContent['conferences'][$g]['bronzeSponsors'][$f]['aboutShort']) {
        
        $this->assertIsString($responseContent['conferences'][$g]['bronzeSponsors'][$f]['aboutShort']);
        
        }
        
        $this->assertArrayHasKey('company', $responseContent['conferences'][$g]['bronzeSponsors'][$f]);
        
        if ($responseContent['conferences'][$g]['bronzeSponsors'][$f]['company']) {
        
        $this->assertIsString($responseContent['conferences'][$g]['bronzeSponsors'][$f]['company']);
        
        }
        
        $this->assertArrayHasKey('tagline', $responseContent['conferences'][$g]['bronzeSponsors'][$f]);
        
        if ($responseContent['conferences'][$g]['bronzeSponsors'][$f]['tagline']) {
        
        $this->assertIsString($responseContent['conferences'][$g]['bronzeSponsors'][$f]['tagline']);
        
        }
        
        $this->assertArrayHasKey('noPhotography', $responseContent['conferences'][$g]['bronzeSponsors'][$f]);
        
        if ($responseContent['conferences'][$g]['bronzeSponsors'][$f]['noPhotography']) {
        
        $this->assertIsBool($responseContent['conferences'][$g]['bronzeSponsors'][$f]['noPhotography']);
        ...
        $this->assertArrayHasKey('platformSponsors', $responseContent['conferences'][$g]);
        
        if ($responseContent['conferences'][$g]['platformSponsors']) {
        
        $this->assertIsArray($responseContent['conferences'][$g]['platformSponsors']);
        
        for($f = 0; $f < count($responseContent['conferences'][$g]['platformSponsors']); $f++) {
        
        $this->assertNotNull($responseContent['conferences'][$g]['platformSponsors'][$f]);
        
        $this->assertArrayHasKey('aboutShort', $responseContent['conferences'][$g]['platformSponsors'][$f]);
        
        if ($responseContent['conferences'][$g]['platformSponsors'][$f]['aboutShort']) {
        
        $this->assertIsString($responseContent['conferences'][$g]['platformSponsors'][$f]['aboutShort']);
        
        }
        
        $this->assertArrayHasKey('company', $responseContent['conferences'][$g]['platformSponsors'][$f]);
        
        if ($responseContent['conferences'][$g]['platformSponsors'][$f]['company']) {
        
        $this->assertIsString($responseContent['conferences'][$g]['platformSponsors'][$f]['company']);
        
        }
        
        $this->assertArrayHasKey('tagline', $responseContent['conferences'][$g]['platformSponsors'][$f]);
        
        if ($responseContent['conferences'][$g]['platformSponsors'][$f]['tagline']) {
        
        $this->assertIsString($responseContent['conferences'][$g]['platformSponsors'][$f]['tagline']);
        
        }
        
        $this->assertArrayHasKey('noPhotography', $responseContent['conferences'][$g]['platformSponsors'][$f]);
        
        if ($responseContent['conferences'][$g]['platformSponsors'][$f]['noPhotography']) {
        
        $this->assertIsBool($responseContent['conferences'][$g]['platformSponsors'][$f]['noPhotography']);
