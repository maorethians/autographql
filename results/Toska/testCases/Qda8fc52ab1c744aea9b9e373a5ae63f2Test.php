...
class Qda8fc52ab1c744aea9b9e373a5ae63f2Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query":"{\n  themes {\n    id\n    fonts {\n      primary\n      secondary\n      variants {\n        family\n        weight\n        style\n        fileName\n        href\n      }\n    }\n    textures {\n      url\n      title\n      style {\n        backgroundSize\n      }\n    }\n    colors {\n      primary\n      secondary\n      text\n      background\n    }\n    logos {\n      black {\n        withoutText {\n          title\n        }\n        withText {\n          title\n        }\n      }\n      white {\n        withoutText {\n          title\n        }\n        withText {\n          title\n        }\n      }\n      colored {\n        withoutText {\n          title\n        }\n        withText {\n          title\n        }\n      }\n    }\n  }\n}\n","variables":null,"created_at":"2023-05-05 19:01:59","updated_at":"2023-05-05 19:02:06","times_called":2}
JSON;
        ...
        $this->assertArrayHasKey('black', $responseContent['themes'][$g]['logos']);
        
        $this->assertNotNull($responseContent['themes'][$g]['logos']['black']);
        
        $this->assertArrayHasKey('withoutText', $responseContent['themes'][$g]['logos']['black']);
        
        $this->assertNotNull($responseContent['themes'][$g]['logos']['black']['withoutText']);
        
        $this->assertArrayHasKey('title', $responseContent['themes'][$g]['logos']['black']['withoutText']);
        
        if ($responseContent['themes'][$g]['logos']['black']['withoutText']['title']) {
        
        $this->assertIsString($responseContent['themes'][$g]['logos']['black']['withoutText']['title']);
        
        }
        
        $this->assertArrayHasKey('withText', $responseContent['themes'][$g]['logos']['black']);
        
        $this->assertNotNull($responseContent['themes'][$g]['logos']['black']['withText']);
        
        $this->assertArrayHasKey('title', $responseContent['themes'][$g]['logos']['black']['withText']);
        
        if ($responseContent['themes'][$g]['logos']['black']['withText']['title']) {
        
        $this->assertIsString($responseContent['themes'][$g]['logos']['black']['withText']['title']);
        
        }
        
        $this->assertArrayHasKey('white', $responseContent['themes'][$g]['logos']);
        
        $this->assertNotNull($responseContent['themes'][$g]['logos']['white']);
        
        $this->assertArrayHasKey('withoutText', $responseContent['themes'][$g]['logos']['white']);
        
        $this->assertNotNull($responseContent['themes'][$g]['logos']['white']['withoutText']);
        
        $this->assertArrayHasKey('title', $responseContent['themes'][$g]['logos']['white']['withoutText']);
        
        if ($responseContent['themes'][$g]['logos']['white']['withoutText']['title']) {
        
        $this->assertIsString($responseContent['themes'][$g]['logos']['white']['withoutText']['title']);
        
        }
        
        $this->assertArrayHasKey('withText', $responseContent['themes'][$g]['logos']['white']);
        
        $this->assertNotNull($responseContent['themes'][$g]['logos']['white']['withText']);
        
        $this->assertArrayHasKey('title', $responseContent['themes'][$g]['logos']['white']['withText']);
        
        if ($responseContent['themes'][$g]['logos']['white']['withText']['title']) {
        
        $this->assertIsString($responseContent['themes'][$g]['logos']['white']['withText']['title']);
        
        }
        
        $this->assertArrayHasKey('colored', $responseContent['themes'][$g]['logos']);
        
        $this->assertNotNull($responseContent['themes'][$g]['logos']['colored']);
        
        $this->assertArrayHasKey('withoutText', $responseContent['themes'][$g]['logos']['colored']);
        
        $this->assertNotNull($responseContent['themes'][$g]['logos']['colored']['withoutText']);
        
        $this->assertArrayHasKey('title', $responseContent['themes'][$g]['logos']['colored']['withoutText']);
        
        if ($responseContent['themes'][$g]['logos']['colored']['withoutText']['title']) {
        
        $this->assertIsString($responseContent['themes'][$g]['logos']['colored']['withoutText']['title']);
        
        }
        
        $this->assertArrayHasKey('withText', $responseContent['themes'][$g]['logos']['colored']);
        
        $this->assertNotNull($responseContent['themes'][$g]['logos']['colored']['withText']);
        
        $this->assertArrayHasKey('title', $responseContent['themes'][$g]['logos']['colored']['withText']);
        
        if ($responseContent['themes'][$g]['logos']['colored']['withText']['title']) {
        
        $this->assertIsString($responseContent['themes'][$g]['logos']['colored']['withText']['title']);
