...
class Qa5832bbede5c4150866bf4c53ca2e996Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query":"{\n  conference(id: \"freezing-edge-2020\") {\n    id\n    name\n    organizer {\n      aboutShort\n      company\n      tagline\n      noPhotography\n    }\n    year\n    startDate\n    endDate\n    slogan\n    websiteUrl\n    locations {\n      name\n      about\n      city\n      address\n    }\n    mcs {\n      aboutShort\n      company\n      tagline\n      noPhotography\n    }\n    partners {\n      aboutShort\n      company\n      tagline\n      noPhotography\n    }\n    sponsors {\n      aboutShort\n      company\n      tagline\n      noPhotography\n    }\n    goldSponsors {\n      aboutShort\n      company\n      tagline\n      noPhotography\n    }\n    silverSponsors {\n      aboutShort\n      company\n      tagline\n      noPhotography\n    }\n    bronzeSponsors {\n      aboutShort\n      company\n      tagline\n      noPhotography\n    }\n    platformSponsors {\n      aboutShort\n      company\n      tagline\n      noPhotography\n    }\n  }\n}","variables":null,"created_at":"2023-05-05 18:35:59","updated_at":"2023-05-05 18:35:59","times_called":1}
JSON;
        ...
        $this->assertArrayHasKey('bronzeSponsors', $responseContent['conference']);
        
        if ($responseContent['conference']['bronzeSponsors']) {
        
        $this->assertIsArray($responseContent['conference']['bronzeSponsors']);
        
        for($g = 0; $g < count($responseContent['conference']['bronzeSponsors']); $g++) {
        
        $this->assertNotNull($responseContent['conference']['bronzeSponsors'][$g]);
        
        $this->assertArrayHasKey('aboutShort', $responseContent['conference']['bronzeSponsors'][$g]);
        
        if ($responseContent['conference']['bronzeSponsors'][$g]['aboutShort']) {
        
        $this->assertIsString($responseContent['conference']['bronzeSponsors'][$g]['aboutShort']);
        
        }
        
        $this->assertArrayHasKey('company', $responseContent['conference']['bronzeSponsors'][$g]);
        
        if ($responseContent['conference']['bronzeSponsors'][$g]['company']) {
        
        $this->assertIsString($responseContent['conference']['bronzeSponsors'][$g]['company']);
        
        }
        
        $this->assertArrayHasKey('tagline', $responseContent['conference']['bronzeSponsors'][$g]);
        
        if ($responseContent['conference']['bronzeSponsors'][$g]['tagline']) {
        
        $this->assertIsString($responseContent['conference']['bronzeSponsors'][$g]['tagline']);
        
        }
        
        $this->assertArrayHasKey('noPhotography', $responseContent['conference']['bronzeSponsors'][$g]);
        
        if ($responseContent['conference']['bronzeSponsors'][$g]['noPhotography']) {
        
        $this->assertIsBool($responseContent['conference']['bronzeSponsors'][$g]['noPhotography']);
        ...
        $this->assertArrayHasKey('platformSponsors', $responseContent['conference']);
        
        if ($responseContent['conference']['platformSponsors']) {
        
        $this->assertIsArray($responseContent['conference']['platformSponsors']);
        
        for($g = 0; $g < count($responseContent['conference']['platformSponsors']); $g++) {
        
        $this->assertNotNull($responseContent['conference']['platformSponsors'][$g]);
        
        $this->assertArrayHasKey('aboutShort', $responseContent['conference']['platformSponsors'][$g]);
        
        if ($responseContent['conference']['platformSponsors'][$g]['aboutShort']) {
        
        $this->assertIsString($responseContent['conference']['platformSponsors'][$g]['aboutShort']);
        
        }
        
        $this->assertArrayHasKey('company', $responseContent['conference']['platformSponsors'][$g]);
        
        if ($responseContent['conference']['platformSponsors'][$g]['company']) {
        
        $this->assertIsString($responseContent['conference']['platformSponsors'][$g]['company']);
        
        }
        
        $this->assertArrayHasKey('tagline', $responseContent['conference']['platformSponsors'][$g]);
        
        if ($responseContent['conference']['platformSponsors'][$g]['tagline']) {
        
        $this->assertIsString($responseContent['conference']['platformSponsors'][$g]['tagline']);
        
        }
        
        $this->assertArrayHasKey('noPhotography', $responseContent['conference']['platformSponsors'][$g]);
        
        if ($responseContent['conference']['platformSponsors'][$g]['noPhotography']) {
        
        $this->assertIsBool($responseContent['conference']['platformSponsors'][$g]['noPhotography']);
