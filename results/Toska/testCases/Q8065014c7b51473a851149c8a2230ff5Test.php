...
class Q8065014c7b51473a851149c8a2230ff5Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query":"{\n  themes {\n    id\n    fonts {\n      primary\n      secondary\n      variants {\n        family\n        weight\n        style\n        fileName\n        href\n      }\n    }\n    textures {\n      url\n      title\n      style {\n        backgroundSize\n      }\n    }\n    colors {\n      primary\n      secondary\n      text\n      background\n    }\n    logos {\n      black\n      colored\n      white\n    }\n  }\n}\n","variables":null,"created_at":"2023-05-05 19:01:29","updated_at":"2023-05-05 19:01:29","times_called":1}
JSON;
