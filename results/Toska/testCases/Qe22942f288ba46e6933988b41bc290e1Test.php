...
class Qe22942f288ba46e6933988b41bc290e1Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query":"{\n  conferences {\n    id\n    name\n    allSpeakers {\n      aboutShort\n      company\n      tagline\n      noPhotography\n    }\n    speakers {\n      aboutShort\n      company\n      tagline\n      noPhotography\n    }\n    keynoteSpeakers {\n      aboutShort\n      company\n      tagline\n      noPhotography\n    }\n    fullTalkSpeakers {\n      aboutShort\n      company\n      tagline\n      noPhotography\n    }\n    lightningTalkSpeakers {\n      aboutShort\n      company\n      tagline\n      noPhotography\n    }\n    workshopInstructors {\n      aboutShort\n      company\n      tagline\n      noPhotography\n    }\n    talks {\n      description\n      day\n      begin\n      end\n    }\n  }\n}","variables":null,"created_at":"2023-05-05 18:26:18","updated_at":"2023-05-05 18:26:18","times_called":1}
JSON;
        ...
        $this->assertArrayHasKey('talks', $responseContent['conferences'][$g]);
        
        if ($responseContent['conferences'][$g]['talks']) {
        
        $this->assertIsArray($responseContent['conferences'][$g]['talks']);
        
        for($f = 0; $f < count($responseContent['conferences'][$g]['talks']); $f++) {
        
        $this->assertNotNull($responseContent['conferences'][$g]['talks'][$f]);
        
        $this->assertArrayHasKey('description', $responseContent['conferences'][$g]['talks'][$f]);
        
        if ($responseContent['conferences'][$g]['talks'][$f]['description']) {
        
        $this->assertIsString($responseContent['conferences'][$g]['talks'][$f]['description']);
        
        }
        
        $this->assertArrayHasKey('day', $responseContent['conferences'][$g]['talks'][$f]);
        
        if ($responseContent['conferences'][$g]['talks'][$f]['day']) {
        
        $this->assertIsString($responseContent['conferences'][$g]['talks'][$f]['day']);
        
        }
        
        $this->assertArrayHasKey('begin', $responseContent['conferences'][$g]['talks'][$f]);
        
        if ($responseContent['conferences'][$g]['talks'][$f]['begin']) {
        
        $this->assertIsString($responseContent['conferences'][$g]['talks'][$f]['begin']);
        
        }
        
        $this->assertArrayHasKey('end', $responseContent['conferences'][$g]['talks'][$f]);
        
        if ($responseContent['conferences'][$g]['talks'][$f]['end']) {
        
        $this->assertIsString($responseContent['conferences'][$g]['talks'][$f]['end']);
