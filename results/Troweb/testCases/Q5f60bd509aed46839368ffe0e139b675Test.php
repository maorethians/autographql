...
class Q5f60bd509aed46839368ffe0e139b675Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query":"{\n  blobMimeTypes {\n    blobType\n    mimeTypes\n    __typename\n  }\n}\n","variables":{"query":{"match_all":{}},"sort":[{"_id":"desc"}]},"operation_name":null,"created_at":"2023-05-07 20:56:23","updated_at":"2023-05-07 20:56:23","times_called":1}
JSON;
        ...
        $this->assertEquals('BlobMimeType' , $responseContent['blobMimeTypes'][$g]['__typename']);
