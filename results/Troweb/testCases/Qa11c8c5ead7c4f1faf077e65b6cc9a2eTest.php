...
class Qa11c8c5ead7c4f1faf077e65b6cc9a2eTest extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query":"{\n  trees {\n    _id\n    name {\n      default\n    }\n    description\n    isPublished\n    rootNodesId\n  }\n}\n","variables":{},"operation_name":null,"created_at":"2023-05-07 21:40:38","updated_at":"2023-05-07 21:40:38","times_called":1}
JSON;
        ...
        $this->assertArrayHasKey('name', $responseContent['trees'][$g]);
        
        $this->assertNotNull($responseContent['trees'][$g]['name']);
        
        $this->assertArrayHasKey('default', $responseContent['trees'][$g]['name']);
        
        $this->assertNotNull($responseContent['trees'][$g]['name']['default']);
        
        $this->assertIsString($responseContent['trees'][$g]['name']['default']);
        
        $this->assertArrayHasKey('description', $responseContent['trees'][$g]);
        
        if ($responseContent['trees'][$g]['description']) {
        
        $this->assertIsString($responseContent['trees'][$g]['description']);
