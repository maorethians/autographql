...
class Qfbd5c1dda02d4333b471721ae63fb805Test extends TestCase
{
...
JSON;
        ...
        $this->assertEquals('UploadBlobInfo' , $responseContent['getBlobUploadSignedUrl'][$g]['__typename']);
        ...
        $this->assertArrayHasKey('formFields', $responseContent['getBlobUploadSignedUrl'][$g]);
        
        if ($responseContent['getBlobUploadSignedUrl'][$g]['formFields']) {
