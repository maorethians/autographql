...
class Q484350da3d5841749d7f594ffd9aa3e7Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query":"{\n  commonFields {\n    type\n    name\n    displayName {\n      default\n      alternatives {\n        displayName\n      }\n    }\n    description\n    multiValued\n    required\n    unique\n    uneditable\n    treeId\n    fields {\n      type\n    }\n    refSchema\n    source\n  }\n}\n","variables":{},"operation_name":null,"created_at":"2023-05-07 21:29:05","updated_at":"2023-05-07 21:29:05","times_called":1}
JSON;
