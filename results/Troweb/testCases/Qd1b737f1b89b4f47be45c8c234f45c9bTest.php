...
class Qd1b737f1b89b4f47be45c8c234f45c9bTest extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query":"{\n  getPlugins {\n    name\n    description\n    readMe\n    official\n    category\n    logo\n    publisher {\n      name\n      company\n      image\n    }\n    endpoint\n    pluginDeploymentConfig {\n      kind\n      maxItemConcurrency\n      triggers\n    }\n    config {\n      ioSchemas {\n        name\n        description\n        type\n        fields {\n          name\n        }\n      }\n    }\n  }\n}\n","variables":{},"operation_name":null,"created_at":"2023-05-07 21:26:27","updated_at":"2023-05-07 21:26:27","times_called":1}
JSON;
