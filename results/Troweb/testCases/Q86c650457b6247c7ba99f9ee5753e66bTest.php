...
class Q86c650457b6247c7ba99f9ee5753e66bTest extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query":"{\n  me {\n    isAdmin\n    authorizationRules {\n      operationNames\n      resources {\n        ancestors {\n          title\n        }\n      }\n    }\n    userInfo {\n      _id\n      email\n      lastname\n      fullname\n    }\n    internationalizationConfig {\n      _id\n      displayName\n      dictionaryName\n      baseDictionaryName\n      dateFormat\n      isEnabled\n      isRTL\n    }\n  }\n}\n","variables":{},"operation_name":null,"created_at":"2023-05-07 21:42:30","updated_at":"2023-05-07 21:42:30","times_called":1}
JSON;
        ...
        $this->assertArrayHasKey('dictionaryName', $responseContent['me']['internationalizationConfig']);
        
        $this->assertNotNull($responseContent['me']['internationalizationConfig']['dictionaryName']);
        
        $this->assertIsString($responseContent['me']['internationalizationConfig']['dictionaryName']);
        
        $this->assertArrayHasKey('baseDictionaryName', $responseContent['me']['internationalizationConfig']);
        
        if ($responseContent['me']['internationalizationConfig']['baseDictionaryName']) {
        
        $this->assertContains($responseContent['me']['internationalizationConfig']['baseDictionaryName'], ['enUS', 'fa', 'ar']);
        
        }
        
        $this->assertArrayHasKey('dateFormat', $responseContent['me']['internationalizationConfig']);
        
        if ($responseContent['me']['internationalizationConfig']['dateFormat']) {
        
        $this->assertIsString($responseContent['me']['internationalizationConfig']['dateFormat']);
        ...
        $this->assertArrayHasKey('isRTL', $responseContent['me']['internationalizationConfig']);
        
        $this->assertNotNull($responseContent['me']['internationalizationConfig']['isRTL']);
        
        $this->assertIsBool($responseContent['me']['internationalizationConfig']['isRTL']);
