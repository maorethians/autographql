...
class Qd428a5c5d518481fb2cf88691d78acaeTest extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query":"{\n  applicationAppearance {\n    explore {\n      results {\n        view {\n          list {\n            enabled\n            showStatus\n          }\n        }\n      }\n    }\n    search {\n      facets {\n        commonFacets {\n          fieldName\n        }\n        schemas {\n          schemaName\n          sortBy\n        }\n      }\n    }\n  }\n}\n","variables":{"query":{"match_all":{}},"sort":[{"_id":"desc"}]},"operation_name":null,"created_at":"2023-05-07 20:54:28","updated_at":"2023-05-07 20:54:28","times_called":1}
JSON;
