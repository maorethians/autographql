...
class Qfa33b410d91f4a4b89ba4d07be2ef1cfTest extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query":"{\n  commonFields {\n    type\n    name\n    displayName {\n      default\n      alternatives {\n        displayName\n      }\n    }\n    description\n    multiValued\n    required\n    unique\n    uneditable\n    treeId\n    fields {\n      type\n    }\n    refSchema\n  }\n}\n","variables":{},"operation_name":null,"created_at":"2023-05-07 21:29:01","updated_at":"2023-05-07 21:29:01","times_called":1}
JSON;
