...
class Qb1fd70c3d9c748f5956dc875519540d9Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query":"{\n  getPlugins {\n    name\n    description\n    readMe\n    official\n    category\n    logo\n    publisher {\n      name\n      company\n      image\n    }\n    endpoint\n    pluginDeploymentConfig {\n      kind\n      maxItemConcurrency\n      triggers\n    }\n    config {\n      ioSchemas {\n        name\n        description\n        type\n        fields {\n          name\n          type\n          isArray\n          required\n          fields {\n            name\n          }\n        }\n      }\n    }\n  }\n}\n","variables":{},"operation_name":null,"created_at":"2023-05-07 21:26:50","updated_at":"2023-05-07 21:26:50","times_called":1}
JSON;
        ...
        $this->assertArrayHasKey('fields', $responseContent['getPlugins'][$g]['config']['ioSchemas'][$f]);
        
        $this->assertNotNull($responseContent['getPlugins'][$g]['config']['ioSchemas'][$f]['fields']);
        
        $this->assertIsArray($responseContent['getPlugins'][$g]['config']['ioSchemas'][$f]['fields']);
        
        for($e = 0; $e < count($responseContent['getPlugins'][$g]['config']['ioSchemas'][$f]['fields']); $e++) {
        
        $this->assertNotNull($responseContent['getPlugins'][$g]['config']['ioSchemas'][$f]['fields'][$e]);
        
        $this->assertArrayHasKey('name', $responseContent['getPlugins'][$g]['config']['ioSchemas'][$f]['fields'][$e]);
        
        $this->assertNotNull($responseContent['getPlugins'][$g]['config']['ioSchemas'][$f]['fields'][$e]['name']);
        
        $this->assertIsString($responseContent['getPlugins'][$g]['config']['ioSchemas'][$f]['fields'][$e]['name']);
        
        $this->assertArrayHasKey('type', $responseContent['getPlugins'][$g]['config']['ioSchemas'][$f]['fields'][$e]);
        
        $this->assertNotNull($responseContent['getPlugins'][$g]['config']['ioSchemas'][$f]['fields'][$e]['type']);
        
        $this->assertContains($responseContent['getPlugins'][$g]['config']['ioSchemas'][$f]['fields'][$e]['type'], ['Object', 'TreeTag', 'Ref', 'Blob', 'NestedSchema', 'ObjectId', 'Int', 'Integer', 'Float', 'Decimal', 'Boolean', 'String', 'ShortText', 'LongText', 'DateTime', 'Date', 'Time', 'JSON', 'RichText', 'Duration']);
        
        $this->assertArrayHasKey('isArray', $responseContent['getPlugins'][$g]['config']['ioSchemas'][$f]['fields'][$e]);
        
        if ($responseContent['getPlugins'][$g]['config']['ioSchemas'][$f]['fields'][$e]['isArray']) {
        
        $this->assertIsBool($responseContent['getPlugins'][$g]['config']['ioSchemas'][$f]['fields'][$e]['isArray']);
        
        }
        
        $this->assertArrayHasKey('required', $responseContent['getPlugins'][$g]['config']['ioSchemas'][$f]['fields'][$e]);
        
        if ($responseContent['getPlugins'][$g]['config']['ioSchemas'][$f]['fields'][$e]['required']) {
        
        $this->assertIsBool($responseContent['getPlugins'][$g]['config']['ioSchemas'][$f]['fields'][$e]['required']);
        
        }
        
        $this->assertArrayHasKey('fields', $responseContent['getPlugins'][$g]['config']['ioSchemas'][$f]['fields'][$e]);
        
        if ($responseContent['getPlugins'][$g]['config']['ioSchemas'][$f]['fields'][$e]['fields']) {
        
        $this->assertIsArray($responseContent['getPlugins'][$g]['config']['ioSchemas'][$f]['fields'][$e]['fields']);
        
        for($d = 0; $d < count($responseContent['getPlugins'][$g]['config']['ioSchemas'][$f]['fields'][$e]['fields']); $d++) {
        
        $this->assertNotNull($responseContent['getPlugins'][$g]['config']['ioSchemas'][$f]['fields'][$e]['fields'][$d]);
        
        $this->assertArrayHasKey('name', $responseContent['getPlugins'][$g]['config']['ioSchemas'][$f]['fields'][$e]['fields'][$d]);
        
        $this->assertNotNull($responseContent['getPlugins'][$g]['config']['ioSchemas'][$f]['fields'][$e]['fields'][$d]['name']);
        
        $this->assertIsString($responseContent['getPlugins'][$g]['config']['ioSchemas'][$f]['fields'][$e]['fields'][$d]['name']);
