...
class Q7a70008fd1b44640ada1f405ffd16b45Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query":"{\n  me {\n    isAdmin\n    authorizationRules {\n      operationNames\n      resources {\n        ancestors {\n          title\n        }\n      }\n    }\n    userInfo {\n      _id\n      email\n      lastname\n      fullname\n    }\n    internationalizationConfig {\n      _id\n      displayName\n      dictionaryName\n      baseDictionaryName\n      isEnabled\n      isRTL\n    }\n  }\n}\n","variables":{},"operation_name":null,"created_at":"2023-05-07 21:42:25","updated_at":"2023-05-07 21:42:25","times_called":1}
JSON;
