...
class Qd71c4daceb954a1c9de77faf657f30b6Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query":"{\n  me {\n    isAdmin\n    authorizationRules {\n      operationNames\n      resources {\n        ancestors {\n          title\n        }\n      }\n    }\n    userInfo {\n      _id\n      email\n      lastname\n      fullname\n    }\n    internationalizationConfig {\n      _id\n      displayName\n      translations\n    }\n  }\n}\n","variables":{},"operation_name":null,"created_at":"2023-05-07 21:42:09","updated_at":"2023-05-07 21:42:09","times_called":1}
JSON;
        ...
        $this->assertArrayHasKey('translations', $responseContent['me']['internationalizationConfig']);
        
        if ($responseContent['me']['internationalizationConfig']['translations']) {
