...
class Q762b0cee93c749e8a8d09089e3255093Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query":"query search($query: JSON!, $sort: JSON!) {\n  search(limit: 10, offset: 0, query: $query, sort: $sort) {\n    items {\n      _id\n      subjects {\n        _id\n      }\n    }\n    total\n    limit\n    offset\n    totalRelation\n    aggregations\n    __typename\n  }\n}\n","variables":{"query":{"match_all":{}},"sort":[{"_id":"desc"}]},"operation_name":"search","created_at":"2023-05-07 20:48:18","updated_at":"2023-05-07 20:48:18","times_called":1}
JSON;
