...
class Q8e77884ec719467f9169103157fa8518Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query":"query search($query: JSON!, $sort: JSON!) {\n  search(limit: 10, offset: 0, query: $query, sort: $sort) {\n    items {\n      _id\n      subjects {\n        _id\n      }\n    }\n    total\n    limit\n    offset\n    totalRelation\n  }\n}\n","variables":{"query":{"match_all":{}},"sort":[{"_id":"desc"}]},"operation_name":"search","created_at":"2023-05-07 20:48:05","updated_at":"2023-05-07 20:48:05","times_called":1}
JSON;
