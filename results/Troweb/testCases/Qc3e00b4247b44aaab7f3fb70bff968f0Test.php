...
class Qc3e00b4247b44aaab7f3fb70bff968f0Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query":"{\n  getPlugins {\n    name\n    description\n    readMe\n    official\n    category\n    logo\n    publisher {\n      name\n      company\n      image\n    }\n    endpoint\n    pluginDeploymentConfig {\n      kind\n      maxItemConcurrency\n      triggers\n    }\n    config {\n      ioSchemas {\n        name\n        description\n        type\n        fields {\n          name\n          type\n        }\n      }\n    }\n  }\n}\n","variables":{},"operation_name":null,"created_at":"2023-05-07 21:26:30","updated_at":"2023-05-07 21:26:30","times_called":1}
JSON;
