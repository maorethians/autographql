...
class Qc80b58ed84d14bbfa844773491a693e8Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query":"{\n  orgInfo {\n    id\n    name\n    logo\n    isRestricted\n    internationalizationConfigs {\n      _id\n      isDefault\n      isRTL\n      displayName\n      baseDictionaryName\n    }\n    group {\n      name\n      featureFlags\n    }\n  }\n}\n","variables":{},"operation_name":null,"created_at":"2023-05-07 21:23:15","updated_at":"2023-05-07 21:23:15","times_called":1}
JSON;
        ...
        $this->assertArrayHasKey('featureFlags', $responseContent['orgInfo']['group']);
        
        if ($responseContent['orgInfo']['group']['featureFlags']) {
        
        $this->assertIsArray($responseContent['orgInfo']['group']['featureFlags']);
        
        for($g = 0; $g < count($responseContent['orgInfo']['group']['featureFlags']); $g++) {
        
        $this->assertNotNull($responseContent['orgInfo']['group']['featureFlags'][$g]);
        
        $this->assertIsString($responseContent['orgInfo']['group']['featureFlags'][$g]);
