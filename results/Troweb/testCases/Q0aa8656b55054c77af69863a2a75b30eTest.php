...
class Q0aa8656b55054c77af69863a2a75b30eTest extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query":"{\n  getPlans {\n    _id\n    name\n    description\n    totalUsage {\n      storage {\n        bound\n      }\n    }\n    rateLimitation {\n      apiCalls {\n        bound\n        period\n      }\n    }\n    featuresAccessibility {\n      authorization\n      apiKeys {\n        bound\n      }\n    }\n    subscriptionPlans {\n      _id\n      active\n    }\n  }\n}\n","variables":{},"operation_name":null,"created_at":"2023-05-07 21:24:05","updated_at":"2023-05-07 21:24:05","times_called":1}
JSON;
