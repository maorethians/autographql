...
class Qdd71bc547a9c49c3a3369d19668db278Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query":"{\n  getTreeNodes(treeId: \"6454b9160379e02c19d86a24\") {\n    _id\n    title {\n      default\n    }\n    originId\n    treeId\n    children {\n      _id\n      title {\n        default\n      }\n    }\n    ancestors {\n      _id\n      treeId\n    }\n  }\n}\n","variables":{},"operation_name":null,"created_at":"2023-05-07 21:36:46","updated_at":"2023-05-07 21:36:46","times_called":1}
JSON;
        ...
        $this->assertArrayHasKey('treeId', $responseContent['getTreeNodes'][$g]['ancestors'][$f]);
        
        $this->assertNotNull($responseContent['getTreeNodes'][$g]['ancestors'][$f]['treeId']);
