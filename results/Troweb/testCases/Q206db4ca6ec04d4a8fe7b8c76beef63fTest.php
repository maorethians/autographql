...
class Q206db4ca6ec04d4a8fe7b8c76beef63fTest extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query":"{\n  getPlugins {\n    name\n    description\n    readMe\n    official\n    category\n    logo\n    publisher {\n      name\n      company\n      image\n    }\n    endpoint\n    pluginDeploymentConfig {\n      kind\n      maxItemConcurrency\n      triggers\n    }\n    config {\n      ioSchemas {\n        name\n        description\n      }\n    }\n  }\n}\n","variables":{},"operation_name":null,"created_at":"2023-05-07 21:26:21","updated_at":"2023-05-07 21:26:21","times_called":1}
JSON;
