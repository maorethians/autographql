...
class Qb8918e1e1c0b45d2a0cf6db45c35be06Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query":"{\n  getItems(ids: [\"000000000000000000000000\"]) {\n    _id\n    title\n    parentId\n    externalId\n    subjects {\n      _id\n      title {\n        default\n      }\n      originId\n      ancestors {\n        _id\n      }\n    }\n    ancestors {\n      title\n    }\n  }\n}\n","variables":{},"operation_name":null,"created_at":"2023-05-07 21:17:23","updated_at":"2023-05-07 21:17:23","times_called":1}
JSON;
