...
class Q9f65b89b1b244aae97c4790e5a8965efTest extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query":"{\n  getOrgPlans {\n    _id\n    from\n    to\n    revokedAt\n    plan {\n      name\n      totalUsage {\n        storage {\n          bound\n        }\n      }\n      rateLimitation {\n        apiCalls {\n          bound\n          period\n        }\n      }\n      featuresAccessibility {\n        authorization\n        apiKeys {\n          bound\n        }\n      }\n    }\n    usage {\n      totalUsage {\n        storage\n      }\n      rateLimitation {\n        apiCalls {\n          usage\n          startedAt\n        }\n      }\n    }\n    subscription {\n      externalId\n      interval\n      intervalCount\n    }\n  }\n}\n","variables":{},"operation_name":null,"created_at":"2023-05-07 21:20:40","updated_at":"2023-05-07 21:20:40","times_called":1}
JSON;
